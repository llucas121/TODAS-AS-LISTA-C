...
// seja a intersecção entre os 2 vetores anteriores, ou seja, que contém apenas os
// nu ́meros que estão em ambos os vetores. Não deve conter números repetidos.
